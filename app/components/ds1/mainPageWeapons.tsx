...
export default function clientPart({
  ...
  type Weapon = {
    ...
    Divine: string | number;
    Occult: string | number;
    ...
    Object.keys(data).forEach((weaponClass) => {
      ...
      data[weaponClass].forEach((weaponData: any) => {
        ...
        const weapon: Weapon = {
          ...
          Divine: weaponInfo.Divine,
          Occult: weaponInfo.Occult,
  ...
  function makeRow(item: any) {
    return (
      <div className="flex overflow-hidden " key={item.name}>
        ...
        <div
          className={
            "row-item go-up animation-delay-800 " +
            correctBg(item.Divine, correctAnswer.Divine)
          }
        >
          {item.Divine}
        </div>
        <div
          className={
            "row-item go-up animation-delay-900 " +
            correctBg(item.Occult, correctAnswer.Occult)
          }
        >
          {item.Occult}
        </div>
    ...
    <div className="min-h-screen w-full flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col w-full h-full items-center justify-center ">
        ...
        <div className="w-screen overflow-x-auto flex xl:justify-center justify-start">
          <div className="min-w-[1450px] mt-10 flex flex-col items-center m-3">
            {/* Header */}
            <div className="overflow-x-auto overflow-y-scroll w-full">
              <div className="flex items-end shadow-stone-900 shadow-2xl ">
                ...
                <div className="title-grid">Divine</div>
                <div className="title-grid">Occult</div>
